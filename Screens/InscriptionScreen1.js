    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <Text h3 style={{ marginBottom: 40, fontSize: 25, width: "70%", fontFamily: 'Montserrat_300Light', textAlign: 'center' }}>Promis, la prochaine fois on se rappellera de toi !</Text>
